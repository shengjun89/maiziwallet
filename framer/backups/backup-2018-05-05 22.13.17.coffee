...
if Screen.width>1200
	accountBanBg.html = "<div style='background: linear-gradient(-45deg, #FF6F43,#EA3C35);height:840px;filter:hue-rotate(0deg);'></div>"
...
account_iconNavGroup = new Layer
	...
	width: Screen.width
	height: 160*n
	y: accountBanBg.y+accountBanBg.height
	shadowY: 1
	shadowColor: "#e0e0e0"
	backgroundColor: "#FFF"	
